...
/*   Updated: 2017/09/19 20:02:37 by pbernier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <mod1.h>

int		print_line(t_mod *mod1)
{
	int		ret;
...
void	error(t_mod *mod1, int e)
{
	...
	if (e == INVALID_CHAR)
	{
		...
		ft_putstr_fd(tmp, 2);
		ft_memdel((void **)&tmp);
		ft_putstr_fd(": "RED_MINUS"error:"RESET" invalid character '", 2);
